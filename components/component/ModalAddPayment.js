...
const Modal = ({ showModal, setShowModal, payment, setPayment }) => {
  ...
  const addPayment = (e) => {
    ...
    setPayment(payment => [...payment, paymentItem])
    setNamePayment('')
    setName('')
    setId('')
    setShowModal(false)

    const notify = () => toast(`${namePayment} Berhasil Ditambahkan!`, {
      icon: '💴',
    });
              ...
              <div>
                ...
                <div className="flex relative">
                  <input
                    type="text"
                    name="name"
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-3/6 p-2.5 dark:bg-gray-600 "
                  ...
                  <input
                    type="text"
                    name="name"
                    className="bg-gray-50 ml-2 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-3/6 p-2.5 dark:bg-gray-600 "
