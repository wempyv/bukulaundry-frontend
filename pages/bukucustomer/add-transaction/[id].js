                        ...
                        <div className="my-1 items-center">
                            ...
                            >
                                ...
                                <div className="w-full mt-5">
                                    ...
                                    >
                                        <a href={`https://wa.me/${user.whatsapp_number}`} target="_blank" className="flex"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
