    ...
    return (
        <div className="flex flex-col px-2 items-center min-h-screen justify-center md:w-2/5 w-full mx-auto">
            ...
            <button onClick={() => router.push('/bukucustomer/check-invoice')}
                className="rounded w-3/5 mx-auto hover:scale-105  h-[2.8rem] bg-[#232020] text-white text-sm mt-10 hover:bg-[#111010] hover:shadow-xl duration-300 ease-in-out font-medium ml-auto flex items-center justify-center"
            >
                Halaman Invoice
            </button>
        </div>
