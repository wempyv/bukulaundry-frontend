          ...
          <div className="md:flex">
            ...
            <div className="md:w-4/12 flex flex-col md:mx-4">
              <div className="flex items-center">
                ...
                <a className="cursor-pointer" onClick={() => router.push(`/bukucustomer/detail-invoice/${transaction.transaction_unique}`)}>    <svg xmlns="http://www.w3.org/2000/svg" className="mx-4 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
